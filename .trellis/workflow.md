...
> **Windows Git Bash note**: In this project, prefer `python` (or `py -3`) instead of `python3`. On some Windows setups, `python3` resolves to the WindowsApps alias and exits with code `49` before the Trellis script even starts.
